...
* Detail view (for camping sites and ranger stops)
  ...
  * Iteration
    ...
    1. Lines organized circularly. The direction of circumference is the month axis like the arrangement in overview (the node). The direction of radius is the duration of the stay. It's getting closed to the final design...<br>
